...
module z_upper_idler(){
    ...
    idler_height = max(alu_profile_side+z_plastic_thickness,2*z_plastic_thickness+bo+cap_diameter+2*bt+wxd);
    idler_depth = 2*z_plastic_thickness+bo+alu_profile_side+2*bt+wxd;
    ...
    difference(){
        ...
        translate([idler_width/2-(bw+tolerance*2)/2,z_plastic_thickness+wxd,-1])
            cube([bw+2*tolerance,2*bt+bo,z_plastic_thickness+bo+1+wxd]);
            
        translate([idler_width/2-(bw+tolerance*2)/2,z_plastic_thickness+(bo+2*bt)/2+wxd,z_plastic_thickness+bo+wxd])
            rotate([0,90,0])
                cylinder(r=(bo+2*bt)/2,h=bw+2*tolerance);

        translate([idler_width/2-(bolt_length)/2,z_plastic_thickness+(bo+2*bt)/2+wxd,z_plastic_thickness+bo+wxd])
            rotate([0,90,0])
                cylinder(r=bi/2,h=bolt_length);

        translate([idler_width/2+1,z_plastic_thickness+(bo+2*bt)/2+wxd,z_plastic_thickness+bo+wxd])
            rotate([0,90,0])
        ...
        translate([idler_width/2-(bw+tolerance*2)/2,-1,z_plastic_thickness+bo-(bo+2*bt)/2])
            cube([bw+2*tolerance,z_plastic_thickness+bo+1+wxd,2*bt+bo+bt]);
        ...
        translate([idler_width/2+1,z_plastic_thickness+(bo+2*bt)/2,z_plastic_thickness+bo])
            rotate([0,90,0])
                cylinder(r=bi/2,h=idler_width/2);
